...
import plastic from '../plasticrecycle.jpg'
const images = [
    {
                ...
                <div className='flex flex-wrap justify-center mt-8'>
                    ...
                    {images.map((image, index) => (
                        <div key={index}
                            ...
                            <div className=' flex flex-wrap justify-center mt-8 '>
                                <div className='transition ease-in-out delay-150 shadow-lg shadow-gray-500 rounded-full hover:-translate-y-1 hover:scale-110 duration-300 h-fit group relative'>
                                    <img src={image.src}
                                        alt={image.alt}
                                        className=" rounded-full w-48 h-48 object-cover mx-auto"
                                    />
                                    <div className=" rounded-full inset-0 absolute h-48 w-48 bg-black/50 flex items-center justify-center  group-hover:bottom-0 opacity-0 group-hover:opacity-100 transition-all duration-300 text-center">
                                        <Link href={`/post/${index + 1}`} className="bg-transparent border-2	border-white rounded-md text-white  py-2 px-5">อ่านต่อ</Link>
                                    </div>
